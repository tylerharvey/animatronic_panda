...
#include "board/safety/helpers.h"
#include "board/safety/lateral.h"
#include "board/safety/longitudinal.h"
#include "board/safety/declarations.h"
#include "board/can.h"

// all the safety modes
#include "board/safety/modes/defaults.h"
#include "board/safety/modes/hyundai.h"
#include "board/safety/modes/elm327.h"
...
int safety_fwd_hook(int bus_num, int addr) {
  ...
  // TODO(ejones): if we want to modify forwarding behavior, we can change `blocked` here
