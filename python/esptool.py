...
class FakePort(object):
  ...
  def read(self, llen):
    ret = self.panda._handle.controlRead(usb1.TYPE_VENDOR | usb1.RECIPIENT_DEVICE, 0xe0, 1, 0, 10)
    if ret == '':
      time.sleep(0.1)
      ret = self.panda._handle.controlRead(usb1.TYPE_VENDOR | usb1.RECIPIENT_DEVICE, 0xe0, 1, 0, 10)
    return ret
...
def main():
    ...
    fullargspec =  inspect.getfullargspec(operation_func)
    operation_args = fullargspec.args 
